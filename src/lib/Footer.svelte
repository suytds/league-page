...
<footer class="{!outOfDate ? '' : 'invisible'}" bind:this={el}>
	...
	<!-- PLEASE DO NOT REMOVE THE COPYRIGHT -->
	<span class="copyright">&copy; 2021 - {year} <a href="https://imgur.com/gallery/yoQJv">Show Us Your TDs</a></span>
	<br />
	<!-- PLEASE DO NOT REMOVE THE BUILT BY -->
	<span class="creator">Built by <a href="https://www.lockhaven.edu/~dsimanek/flat/flateart.htm">Dylan Gavel</a><br /></span>
